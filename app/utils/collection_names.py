...
Permite usar diferentes ventanas de ROI (3, 5, 7, 10, 15 días)
...
def get_roi_collection_name(window_days: int) -> str:
    ...
    Args:
        window_days: Número de días de la ventana (3, 5, 7, 10, 15)

    Returns:
        Nombre de la colección (ej: "agent_roi_7d", "agent_roi_15d")

    Examples:
        >>> get_roi_collection_name(7)
        'agent_roi_7d'
        >>> get_roi_collection_name(15)
        'agent_roi_15d'
    """
...
def get_top16_collection_name(window_days: int) -> str:
    ...
    Returns:
        Nombre de la colección (ej: "top16_7d", "top16_15d")

    Examples:
        >>> get_top16_collection_name(7)
        'top16_7d'
        >>> get_top16_collection_name(15)
        'top16_15d'
    """
...
def get_daily_roi_collection_name(window_days: int) -> str:
    ...
    Returns:
        Nombre de la colección (ej: "daily_roi_calc_7d", "daily_roi_calc_15d")

    Examples:
        >>> get_daily_roi_collection_name(7)
        'daily_roi_calc_7d'
        >>> get_daily_roi_collection_name(15)
        'daily_roi_calc_15d'
    """
...
def get_all_valid_windows() -> list[int]:
    ...
    Returns:
        Lista de ventanas válidas [3, 5, 7, 10, 15]
    """
    return [3, 5, 7, 10, 15]
